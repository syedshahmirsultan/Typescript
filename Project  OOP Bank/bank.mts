...
await Welcome();
 ...
 class Customer{
public FirstName(set:string,get:string){

} 
public LastName(set:string,get:string){

}  public Gender(set:string,get:string){

}public Age(set:number,get:number){

}public MobileNumber(set:string,get:string){

}public bankAccount(set:string,get:string){
    ...
    AccountBalance:{this.bankAccount}

}
}
interface IBankAccount{
 Debit(decimal:number):number;
 Credit(decimal:number):number;
